                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <Card className="overflow-hidden">
                    ...
                    <CardContent className="p-4">
                      <h3 className="text-lg font-semibold mb-2">Similar Property</h3>
                      <p className="text-gray-600 text-sm mb-2">123 Example St, City, State</p>
                  ...
                  <Card className="overflow-hidden">
                    ...
                    <CardContent className="p-4">
                      <h3 className="text-lg font-semibold mb-2">Similar Property</h3>
                      <p className="text-gray-600 text-sm mb-2">456 Sample Ave, City, State</p>
                      <div className="flex justify-between text-sm text-gray-500">
                        <span>4 Beds</span>
                        <span>3 Baths</span>
